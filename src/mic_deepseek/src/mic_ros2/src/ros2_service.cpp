...
{
	get_device_srv_ = this->create_service<mic_msg::srv::GetDeviceType>(
		"get_device_info",[this](const std::shared_ptr<mic_msg::srv::GetDeviceType::Request> request,
                                std::shared_ptr<mic_msg::srv::GetDeviceType::Response> response){
		response->success = getDeviceTypeCallback(request,response);
		});
	set_awake_word_srv_ = this->create_service<mic_msg::srv::SetAwakeWord>(
		"set_awake_word",[this](const std::shared_ptr<mic_msg::srv::SetAwakeWord::Request> request,
                                std::shared_ptr<mic_msg::srv::SetAwakeWord::Response> response){
		response->success = setAwakeWordCallback(request,response);
		if(response->success) exit(1);
		});
	switch_mic_srv_ = this->create_service<mic_msg::srv::SwitchMic>(
		"switch_mic_type",[this](const std::shared_ptr<mic_msg::srv::SwitchMic::Request> request,
                                std::shared_ptr<mic_msg::srv::SwitchMic::Response> response){
...
功能: 获取设备版本信息
*********************************************************/
bool Wheeltec_Mic::getDeviceTypeCallback(const std::shared_ptr<mic_msg::srv::GetDeviceType::Request>& request,
                                std::shared_ptr<mic_msg::srv::GetDeviceType::Response>& response){
...
*********************************************************/
bool Wheeltec_Mic::setAwakeWordCallback(const std::shared_ptr<mic_msg::srv::SetAwakeWord::Request>& request,
	                           std::shared_ptr<mic_msg::srv::SetAwakeWord::Response>& response){
...
功能: 切换麦克风类型
*********************************************************/
bool Wheeltec_Mic::switchMicCallback(const std::shared_ptr<mic_msg::srv::SwitchMic::Request>& request,
								std::shared_ptr<mic_msg::srv::SwitchMic::Response>& response){
