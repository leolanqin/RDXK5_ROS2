...
#include "mic_msg/srv/set_awake_word.hpp"
#include "mic_msg/srv/get_device_type.hpp"
#include "mic_msg/srv/switch_mic.hpp"
...
private:
    ...
    rclcpp::Service<mic_msg::srv::GetDeviceType>::SharedPtr get_device_srv_;
    rclcpp::Service<mic_msg::srv::SetAwakeWord>::SharedPtr set_awake_word_srv_;
    rclcpp::Service<mic_msg::srv::SwitchMic>::SharedPtr switch_mic_srv_;
    ...
    bool getDeviceTypeCallback(const std::shared_ptr<mic_msg::srv::GetDeviceType::Request>& request,
                                std::shared_ptr<mic_msg::srv::GetDeviceType::Response>& response);
    bool setAwakeWordCallback(const std::shared_ptr<mic_msg::srv::SetAwakeWord::Request>& request,
                                std::shared_ptr<mic_msg::srv::SetAwakeWord::Response>& response);
    bool switchMicCallback(const std::shared_ptr<mic_msg::srv::SwitchMic::Request>& request,
