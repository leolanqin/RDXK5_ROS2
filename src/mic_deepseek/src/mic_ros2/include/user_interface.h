...
char *begin_ = (char*)"fo|";
char *ASR_RES_PATH = (char*)"/home/wheeltec/wheeltec_ros2/src/wheeltec_mic/wheeltec_mic_ros2/config/msc/res/asr/common.jet"; 		//离线语法识别资源路径，重要，与麦克风及appid绑定
char *GRM_BUILD_PATH = (char*)"/home/wheeltec/wheeltec_ros2/src/wheeltec_mic/wheeltec_mic_ros2/config/msc/res/asr/GrmBuilld";   	//构建离线语法识别网络生成数据保存路径
char *GRM_FILE = (char*)"/home/wheeltec/wheeltec_ros2/src/wheeltec_mic/wheeltec_mic_ros2/config/call.bnf";							//构建离线识别语法网络所用的语法文件，用户自修改文件
char *LEX_NAME = (char*)"contact";
char *APPID = (char*)"2a53d039";
