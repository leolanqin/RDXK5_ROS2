...
#include "deepseek_interfaces/srv/deepseek_chat.hpp"
...
public:
    ...
    void response_callback(rclcpp::Client<deepseek_interfaces::srv::DeepseekChat>::SharedFuture future);
...
private:
    ...
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr deepseek_response_pub_;
    rclcpp::Client<deepseek_interfaces::srv::DeepseekChat>::SharedPtr client_;
